    ...
    return (
        <div className="bg-white px-[23px] lg:px-0 font-primary relative lg:pt-32 pt-12 h-[600px] lg:h-[500px] w-full">
            ...
            <div className="flex flex-col items-center justify-center text-center lg:w-[910px] mx-auto">
                <h1 className="mx-auto text-4xl font-medium lg:text-7xl lg:w-full w-200 text-brandBlack"> Get<span className="not-italic text-transparent bg-clip-text bg-gradient-to-b from-brandBlue via-brandIndigo to-brandGreen"> NEAR </span> Certified!</h1>
                ...
                <div className="container mx-auto text-center">
                    <Link href="/#learning"><a  className="cursor-pointer">                       
